...
const BAS_SETS = [
  ...
  { set:2, theme:"Campus & Classes", items:[
    ...
    {g:"female",p:"Did the professor extend the deadline for the essay?",s:"Yes,",e:"next Monday.",a:["she","very","kindly","moved","it","to"]},
  ...
  { set:6, theme:"Hobbies & Free Time", items:[
    ...
    {g:"female",p:"Have you finished the puzzle you were working on?",s:"Almost,",e:"a few pieces.",a:["I'm","just","still","carefully","missing"]},
  ...
  { set:8, theme:"Health & Fitness", items:[
    ...
    {g:"female",p:"Did the doctor say anything serious?",s:"No,",e:"more rest.",a:["she","just","kindly","told","me","to","get"]},
  ...
  { set:9, theme:"Weather, Seasons & Nature", items:[
    ...
    {g:"female",p:"Did the storm cause any damage?",s:"Luckily,",e:"a few branches.",a:["it","only","actually","knocked","down"]},
  ...
  { set:11, theme:"Friends & Social Life", items:[
    ...
    {g:"female",p:"Did you remember his birthday this year?",s:"Yes,",e:"a small gift.",a:["I","even","kindly","got","him"]},
    {g:"male",p:"Why are you so close to your cousins?",s:"We",e:"as kids.",a:["basically","grew","up","together","right","next","door"]},
    {g:"female",p:"Have you apologized to her yet?",s:"Not yet,",e:"the right words.",a:["I'm","still","trying","really","to","find"]},
